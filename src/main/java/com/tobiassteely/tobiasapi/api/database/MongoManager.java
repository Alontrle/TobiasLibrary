...
import com.tobiassteely.tobiasapi.api.database.worker.request.RequestManager;
import com.tobiassteely.tobiasapi.api.database.worker.request.RequestWorker;
import com.tobiassteely.tobiasapi.api.database.worker.response.ResponseManager;
import com.tobiassteely.tobiasapi.api.database.worker.response.ResponseWorker;
